...
<form method="POST" action="processes/process.user.php?action=update">
        <div id="form-block-half">
            ...
            <input type="text" id="contactno" class="input" name="contactno" value="<?php echo $user->get_user_contactno($id);?>" placeholder="Your contact number..">
...
<div id="id04" class="modal">
  <div #id="form-update" class="modal-content">
    <div class="container">
      ...
      <h2>Update User Contact Number</h2>
      <p>Provide required...</p>

      <form method="POST" id="contactForm" action="processes/process.user.php?action=updatecontact">
      <input type="hidden" id="userid" name="userid" value="<?php echo $id;?>"/>
        <label for="contactno">Current Contact Number</label>
            <input type="text" id="contactno" class="input" name="contactno" placeholder="Current Contact Number"> 
            <label for="crpassword">Current Password</label>
            <input type="password" id="crpassword" class="input" name="crpassword" placeholder="Current Password"> 
...
var modal_contactno = document.getElementById('id04');
